...
```{r, include=TRUE, echo=FALSE, results='hold'}
# aux <- fumadores[ which(fumadores$Tipo!='FI' & fumadores$Tipo!='FM' & fumadores$Tipo!='FP' & fumadores$Tipo!='NF' & fumadores$Tipo!='FL' & fumadores$Tipo!='NI'), ]
...
El boxplot nos sirve para esto

```{r, include=TRUE, echo=FALSE, results='hold'}

# # gráfico de cajas
# #boxplot(cmm_trade_data[, c("weight_kg", "quantity")], col="grey", xlab='', ylab='', horizontal=TRUE)
# 
# boxplot(cmm_trade_data[, c("weight_kg")], col="grey", xlab='', ylab='')
# boxplot.stats(cmm_trade_data$weight_kg)$out
# 
# boxplot(cmm_trade_data[, c("quantity")], col="grey", xlab='', ylab='')
# boxplot.stats(cmm_trade_data$quantity)$out
# 
# 
# outlier_values <- boxplot.stats(cmm_trade_data$weight_kg)$out  # outlier values.
# 
# boxplot(cmm_trade_data$weight_kg, main="Weight Kg", boxwex=0.1)
# 
